  ...
  <div class="container-fluid">
    ...
    <ul class="w-100">
      <li v-for="wifi in wifi_list">
        ...
        <div class="connected" v-if="wifi.actived" @click="disconnect_wifi(wifi)"></div>
        <div class="can_connect" v-if="!wifi.actived" @click="open_wifi_link(wifi)"></div>
      </li>
    </ul>
  </div>
</template>
...
<script>
  import wifi_icon from '@/components/System/wifi_icon';
